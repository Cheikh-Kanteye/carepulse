<div class="flex flex-col gap-6 pb-20">
  ...
  <form class="flex flex-col gap-6" method="POST">
    ...
    <div class="flex flex-col sm:flex-row gap-4">
      <div class="w-full">
        <?= renderInputField(['label' => 'Date of birth', 'id' => 'birth', 'type' => 'text', 'icon' => '/calendar.svg', 'placeholder' => 'Select your date of birth']) ?>
    ...
    <div class="flex flex-col sm:flex-row gap-4">
      <div class="w-full">
        <?= renderInputField(['label' => 'Address', 'id' => 'address', 'type' => 'text', 'placeholder' => 'ex: 14 street, New York, NY - 5101']) ?>
        <?= renderTextError($errors['address'] ?? '') ?>
      </div>

      <div class="w-full">
        <?= renderInputField(['label' => 'Occupation', 'id' => 'occupation', 'type' => 'text', 'placeholder' => 'Software Engineer']) ?>
    ...
    <div class="flex flex-col sm:flex-row gap-4">
      <div class="w-full">
        <?= renderInputField(['label' => 'Emergency contact name', 'id' => 'emergency_contact', 'type' => 'text', 'placeholder' => 'Guardian’s name']) ?>
        <?= renderTextError($errors['emergency_contact'] ?? '') ?>
      </div>

      <div class="w-full">
        <?= renderInputField(['label' => 'Emergency Phone number', 'id' => 'emergency_phone', 'type' => 'tel', 'icon' => '/phone.svg', 'placeholder' => 'ex: +1 (868) 579-9831', 'isPhone' => true]) ?>
    ...
    <div class="flex flex-col sm:flex-row gap-4">
      <div class="w-full">
        <?= renderInputField(['label' => 'Insurance provider', 'id' => 'insurance_provider', 'placeholder' => 'Dr. Adam Smith']) ?>
        <?= renderTextError($errors['insurance_provider'] ?? '') ?>
      </div>

      <div class="w-full">
        <?= renderInputField(['label' => 'Insurance policy number', 'id' => 'insurance_policy', 'placeholder' => 'ex: ABC1234567']) ?>
    ...
    <div class="flex flex-col sm:flex-row gap-4">
      <div class="w-full">
        <?= renderInputField(['label' => 'Allergies (if any)', 'id' => 'allergies', 'type' => 'textarea', 'placeholder' => 'ex: BlueCross']) ?>
        <?= renderTextError($errors['allergies'] ?? '') ?>
      </div>

      <div class="w-full">
        <?= renderInputField(['label' => 'Current medications', 'id' => 'medications', 'type' => 'textarea', 'placeholder' => 'ex: Ibuprofen 200mg, Levothyroxine 50mcg']) ?>
    ...
    <div class="flex flex-col sm:flex-row gap-4">
      <div class="w-full">
        <?= renderInputField(['label' => 'Family medical history (if relevant)', 'id' => 'family_medical_history', 'type' => 'textarea', 'placeholder' => 'ex: Mother had breast cancer']) ?>
        <?= renderTextError($errors['family_medical_history'] ?? '') ?>
      </div>

      <div class="w-full">
        <?= renderInputField(['label' => 'Past medical history', 'id' => 'past_medical_history', 'type' => 'textarea', 'placeholder' => 'ex: Asthma diagnosis in childhood']) ?>
    ...
    <div>
      <?= renderInputField(['label' => 'Identification Number', 'id' => 'id_number', 'type' => 'text', 'placeholder' => 'ex: 1234567']) ?>
